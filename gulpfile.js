  ...
  return gulp.src([
    ...
    .pipe(fileinclude({
        ...
        context: {
          ...
          slider: [ 'abqary.png', 'fat.png', 'ki.png', 'man.png', 'mas.png', 'vh.png'],
          blog: [ '05.png', '06.png', '07.png', '08.png', '05.png', '06.png', '07.png', '08.png',]
        }
      })
    )
...
exports.default = async function () {
  ...
  buildAndReload();
  // Watch task
  watch(["./*.html", "./views/**/*.html", "src/**/*.*"], series(buildAndReload));
};